import { RULES, validateEmail, validateIdentical, validateNotEmpty, validatePasswordLength } from "./Rules";
...
export const validate = (field: string, rule: RULES, targetParams: IValidationParameter) : IAPIResponse => {
